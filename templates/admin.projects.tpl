      ...
      <div class="edit">
         <form action="/admin/projects" method="post" class="item_edit" id="item{$d.projects_id}">
            ...
            <div class="form_block">
              ...
              <textarea name="body" id="body_{$smarty.foreach.f.index}">{if $isInsert}{$d.projects_body}{else}{$body|default:$d.projects_body}{/if}</textarea>
            </div>
            <div class="form_block">
         ...
         <div class="in text_in">
            ...
            <ul>
               {if !empty($d.projects_text_photo_id)}
                  <li><a href="/images/uploads/{$d.projects_text_photo_id.name}_b.{$d.projects_text_photo_id.ext}"><img src="/images/uploads/{$d.projects_text_photo_id.name}_s.{$d.projects_text_photo_id.ext}" /></a><button class="x" data="{$d.projects_text_photo_id.name}" data-ext="{$d.projects_text_photo_id.ext}">x</button><button class="url" data="{$server_root}/images/uploads/{$d.projects_text_photo_id.name}_b.{$d.projects_text_photo_id.ext}">URL</button></li>
               {/if}
            </ul>
         </div>
      </div>
   ...
   <div class="add">
      <form action="/admin/projects" method="post">
         ...
         <div class="form_block">
           ...
           <textarea name="body" id="body_new">{$body}</textarea>
         </div>
         <div class="form_block">
