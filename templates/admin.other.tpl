    ...
    <form action="/admin/other" method="post" id="add_article">
      <div class="form_block">
      	<div class="checkbox_in">
        	<div><input type="checkbox" name="is_visible" id="is_visible" {if $setting.settings_flag}checked="checked"{/if} value="1"/><label for="article_head">{$setting.settings_head}</label></div>
      	</div>
      </div>
